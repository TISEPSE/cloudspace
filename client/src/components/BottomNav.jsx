        ...
        {items.map(item => {
          ...
          return (
            <NavLink
              key={item.path}
              to={item.path}
              className={`flex-1 flex flex-col items-center justify-center gap-1 py-1.5 transition-colors select-none active:bg-slate-100 dark:active:bg-border-dark/70 ${
                isActive
                  ? 'text-primary'
